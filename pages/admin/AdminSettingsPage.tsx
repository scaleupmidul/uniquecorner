                ...
                <div className="space-y-6">
                    <div className={cardClass}>
                        ...
                        <div className="p-4 bg-emerald-50 rounded-xl border border-emerald-100 mb-6">
                            <h4 className="text-[11px] font-bold text-emerald-900 uppercase mb-2">How to get these?</h4>
                            <ul className="text-[10px] text-emerald-800 space-y-1 list-disc ml-4">
                        ...
                        <div className="grid grid-cols-1 gap-6">
                            <div className="space-y-4 pt-4 border-t border-emerald-100">
                                <h4 className="text-[11px] font-bold text-emerald-900 uppercase">Google Analytics 4</h4>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="space-y-1">
                            ...
                            <div className="space-y-4 pt-4 border-t border-blue-100">
                                <h4 className="text-[11px] font-bold text-blue-900 uppercase">Meta (Facebook) CAPI</h4>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="space-y-1">
